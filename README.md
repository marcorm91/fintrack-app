...
- Windows instalador: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5_x64-setup.exe)
- Windows MSI: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5_x64_en-US.msi)
- Windows portable ZIP: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5_portable_windows.zip)
- macOS Apple Silicon: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5_aarch64.dmg)
- Linux AppImage: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5_amd64.AppImage)
- Linux DEB: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5_amd64.deb)
- Linux RPM: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5-1.x86_64.rpm)
- Android APK: [Fintrack 3.0.5](https://github.com/marcorm91/fintrack-app/releases/download/v3.0.5/Fintrack_3.0.5_android.apk)

Los enlaces estarán disponibles cuando se publique la release `v3.0.5`.
...
Al publicar un tag `v*`, por ejemplo `v3.0.5`, GitHub Actions genera los paquetes de Windows, macOS, Linux y Android, y crea la release con sus artefactos.
